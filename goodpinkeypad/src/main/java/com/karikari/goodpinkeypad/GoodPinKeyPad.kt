...
class GoodPinKeyPad : LinearLayout {
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet?) {
        ...
        themeMap[2] = context.resources.getDrawable(R.drawable.keys_black_theme, context.theme)
        themeMap[3] =
        ...
        holoMap[2] = context.resources.getDrawable(R.drawable.black_hollow_dot, context.theme)
        holoMap[3] = context.resources.getDrawable(R.drawable.white_hollow_dot, context.theme)
        ...
        canCelMap[1] = context.resources.getDrawable(R.drawable.clear_white, context.theme)
    ...
    private fun dpToPx(valueInDp: Float): Int {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, valueInDp, this.resources.displayMetrics).toInt()
    }

    private fun dpToPxF(valueInDp: Float): Float {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, valueInDp, this.resources.displayMetrics)
    }
