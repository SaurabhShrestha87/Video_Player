...
import com.video.offline.videoplayer.car.VLCCarService
...
import com.video.offline.videoplayer.gui.video.PopupManager
...
import com.video.offline.videoplayer.media.PlayerController
...
import com.video.offline.videoplayer.util.PlaybackAction
import com.video.offline.videoplayer.util.RendererLiveData
...
import com.video.offline.videoplayer.util.VLCAudioFocusHelper
import com.video.offline.videoplayer.util.awaitMedialibraryStarted
import com.video.offline.videoplayer.util.isSchemeHttpOrHttps
...
import com.video.offline.videoplayer.widget.VLCAppWidgetProvider
    ...
    private fun broadcastMetadata() {
        ...
        if (lifecycleScope.isActive) lifecycleScope.launch(Dispatchers.Default) {
            sendBroadcast(Intent("com.android.music.metachanged")
                    ...
                    .putExtra("package", "com.video.offline.videoplayer")
                    .apply {
