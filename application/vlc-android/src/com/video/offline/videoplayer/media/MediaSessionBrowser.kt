...
import com.video.offline.videoplayer.gui.helpers.MediaComparators
import com.video.offline.videoplayer.gui.helpers.MediaComparators.formatArticles
import com.video.offline.videoplayer.isPathValid
import com.video.offline.videoplayer.media.MediaUtils.getMediaAlbum
import com.video.offline.videoplayer.media.MediaUtils.getMediaArtist
import com.video.offline.videoplayer.media.MediaUtils.getMediaSubtitle
 ...
 *
 * Root node
 * //com.video.offline.videoplayer/{r}oot[?{f}latten=1]
 * Root menu
 * //com.video.offline.videoplayer/{r}oot/home
 * //com.video.offline.videoplayer/{r}oot/playlist/<id>
 * //com.video.offline.videoplayer/{r}oot/{l}ib
 * //com.video.offline.videoplayer/{r}oot/stream
 * Home menu
 * //com.video.offline.videoplayer/{r}oot/home/shuffle_all
 * //com.video.offline.videoplayer/{r}oot/home/last_added[?{i}ndex=<track num>]
 * //com.video.offline.videoplayer/{r}oot/home/history[?{i}ndex=<track num>]
 * Library menu
 * //com.video.offline.videoplayer/{r}oot/{l}ib/a{r}tist[?{p}age=<page num>]
 * //com.video.offline.videoplayer/{r}oot/{l}ib/a{r}tist/<id>
 * //com.video.offline.videoplayer/{r}oot/{l}ib/a{l}bum[?{p}age=<page num>]
 * //com.video.offline.videoplayer/{r}oot/{l}ib/a{l}bum/<id>
 * //com.video.offline.videoplayer/{r}oot/{l}ib/{t}rack[?{p}age=<page num>]
 * //com.video.offline.videoplayer/{r}oot/{l}ib/{t}rack[?{p}age=<page num>][&{i}ndex=<track num>]
 * //com.video.offline.videoplayer/{r}oot/{l}ib/{g}enre[?{p}age=<page num>]
 * //com.video.offline.videoplayer/{r}oot/{l}ib/{g}enre/<id>
 * Media
 * //com.video.offline.videoplayer/media/<id>
 * Errors
 * //com.video.offline.videoplayer/error/media
 * //com.video.offline.videoplayer/error/playlist
 * Search
 * //com.video.offline.videoplayer/search?query=<query>
 */
