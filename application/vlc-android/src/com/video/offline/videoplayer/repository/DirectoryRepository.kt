...
class DirectoryRepository (private val customDirectoryDao: CustomDirectoryDao) : IOScopedObject() {
    ...
    fun addCustomDirectory(path: String): Job = launch {
        customDirectoryDao.insert(com.video.offline.videoplayer.mediadb.models.CustomDirectory(path))
    }
    ...
    fun deleteCustomDirectory(path: String) = launch { customDirectoryDao.delete(com.video.offline.videoplayer.mediadb.models.CustomDirectory(path)) }
