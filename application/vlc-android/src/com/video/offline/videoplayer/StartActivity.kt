...
import com.video.offline.videoplayer.gui.BetaWelcomeActivity
import com.video.offline.videoplayer.gui.helpers.hf.StoragePermissionsDelegate.Companion.getStoragePermission
import com.video.offline.videoplayer.gui.onboarding.ONBOARDING_DONE_KEY
import com.video.offline.videoplayer.gui.onboarding.startOnboarding
...
import com.video.offline.videoplayer.util.checkWatchNextId
    ...
    private fun resume() {
        ...
        if (Intent.ACTION_SEARCH == action || ACTION_SEARCH_GMS == action) {
            ...
            if (action != null && action.startsWith("vlc.mediashortcut:")) {
                ...
                startActivity(Intent().apply { component = ComponentName(this@StartActivity, "com.video.offline.videoplayer.webserver.gui.remoteaccess.RemoteAccessShareActivity") })
            } else {
