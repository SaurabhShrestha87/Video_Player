...
import com.video.offline.videoplayer.gui.audio.AudioPlayer
import com.video.offline.videoplayer.gui.audio.AudioPlaylistTipsDelegate
import com.video.offline.videoplayer.gui.audio.AudioTipsDelegate
...
open class AudioPlayerContainerActivity : BaseActivity(), KeycodeListener, SchedulerCallback {
    ...
    private fun initAudioPlayer() {
        ...
        playerBehavior.setLayoutListener {
            ...
            audioPlayer.showCover(settings.getBoolean("audio_player_show_cover", true))
