 ...
 * Once the buffering is finished, a broadcast is sent to com.video.offline.videoplayerbenchmark's service
...
class BenchActivity : ShallowVideoPlayer() {
    ...
    *  extend the length of the benchmark*/
     ...
     * trigger screenshot in com.video.offline.videoplayerbenchmark's service
     *
    ...
    companion object {
        ...
        private const val ACTION_TRIGGER_SCREENSHOT = "com.video.offline.videoplayerbenchmark.TRIGGER_SCREENSHOT"
        private const val ACTION_CONTINUE_BENCHMARK = "com.video.offline.videoplayer.gui.video.benchmark.CONTINUE_BENCHMARK"
