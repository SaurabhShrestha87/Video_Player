...
class ConfirmMakePrivateDialog : VLCBottomSheetDialogFragment() {
    ...
    companion object {
        ...
        /**
         * Create a new ConfirmMakePrivateDialog
         ...
         */
        fun newInstance(medias: ArrayList<MediaLibraryItem> = arrayListOf(), title:String ="", description:String ="", buttonText:String=""): ConfirmMakePrivateDialog {

            return ConfirmMakePrivateDialog().apply {
