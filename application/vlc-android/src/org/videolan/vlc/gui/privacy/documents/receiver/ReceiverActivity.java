 ...
 */
package org.videolan.vlc.gui.privacy.documents.receiver;
...
import org.videolan.vlc.gui.privacy.task.TaskExecutor;
...
public class ReceiverActivity extends Activity {
    ...
    private void onImportStarted() {
        final Dialog dialog = new AlertDialog.Builder(this, R.style.Base_Theme_AppCompat_Dialog)
                .setMessage(R.string.receiver_importing_message)
                .setCancelable(false)
                .create();
