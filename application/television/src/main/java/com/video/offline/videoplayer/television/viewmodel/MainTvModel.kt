...
package com.video.offline.videoplayer.television.viewmodel
...
import com.video.offline.videoplayer.television.ui.FAVORITE_FLAG
import com.video.offline.videoplayer.television.ui.MainTvActivity
import com.video.offline.videoplayer.television.ui.NowPlayingDelegate
import com.video.offline.videoplayer.television.ui.audioplayer.AudioPlayerActivity
import com.video.offline.videoplayer.television.ui.browser.TVActivity
                ...
                item.metadata.mlId?.let {
                    viewModelScope.launch {
                        context.getFromMl {
                            ...
                            val intent = Intent(activity, com.video.offline.videoplayer.television.ui.DetailsActivity::class.java)
                            // pass the item information
                            intent.putExtra("media", it)
                            intent.putExtra("item", com.video.offline.videoplayer.television.ui.MediaItemDetails(it.title, it.artist, it.album, it.location, it.artworkURL))
                            activity.startActivity(intent)
                        }
                    }
                }
            }
            is MediaLibraryItem -> com.video.offline.videoplayer.television.ui.TvUtil.openAudioCategory(activity, item)
        }
    }
