...
class MediaItemDetailsFragment : DetailsSupportFragment(), CoroutineScope by MainScope(), OnItemViewClickedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hasMedia = extras.containsKey(com.video.offline.videoplayer.television.ui.EXTRA_MEDIA)
        fromHistory = extras.getBoolean(EXTRA_FROM_HISTORY, false)
        val media = (extras.parcelable<Parcelable>(com.video.offline.videoplayer.television.ui.EXTRA_MEDIA)
        ...
        viewModel.browserFavUpdated.observe(this, Observer { newMedia ->
            ...
            intent.putExtra(com.video.offline.videoplayer.television.ui.EXTRA_MEDIA, newMedia)
...
//        buildDetails()
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelable(com.video.offline.videoplayer.television.ui.EXTRA_MEDIA, viewModel.media)
