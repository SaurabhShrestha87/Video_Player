    ...
    class AlbumComparator implements Comparator<Album> {
        ...
        public int compare(Album o1, Album o2) {
            switch (sort) {
                ...
                case Medialibrary.SORT_RELEASEDATE:
